...
class HotDrinkMachine {
    ...
    private final Map<AvailableDrink, IHotDrinkFactory> factories =
            new HashMap<>();

    private final List<Pair<String, IHotDrinkFactory>> namedFactories =
            new ArrayList<>();
    ...
    public HotDrinkMachine() throws Exception {
        ...
        for (AvailableDrink drink : AvailableDrink.values()) {
            ...
            Class<?> factory = Class.forName("pattern.factory." + factoryName + "Factory");
        ...
        Set<Class<? extends IHotDrinkFactory>> types =
                new Reflections("pattern.factory") // ""
    ...
    public IHotDrink makeDrink() throws IOException {
        ...
        for (int index = 0; index < namedFactories.size(); ++index) {
            ...
            System.out.println("" + index + ": " + item.getValue().getClass().getSimpleName());
        }
